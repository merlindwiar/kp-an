...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Sep 2020 pada 17.13
...
--
-- Dumping data untuk tabel `billers`
--
...
(26, 'er-20200506-110112', 2, 2, 1, 1, 1260, NULL, '2020-05-06 17:01:12', '2020-05-06 17:01:12'),
(27, 'er-20200609-124344', 2, 1, 1, 1, 500, NULL, '2020-06-09 06:43:44', '2020-06-09 06:43:44'),
(28, 'er-20200609-124406', 2, 2, 1, 1, 1000, NULL, '2020-06-09 06:44:06', '2020-06-09 06:44:06'),
(29, 'er-20200703-064005', 2, 2, 1, 1, 630, NULL, '2020-07-03 12:40:05', '2020-07-03 12:40:05');
...
--
-- Dumping data untuk tabel `gift_cards`
--
...
--
-- Struktur dari tabel `gift_card_recharges`
--
...
--
-- Dumping data untuk tabel `gift_card_recharges`
--
...
--
-- Struktur dari tabel `hrm_settings`
--
...
--
-- Dumping data untuk tabel `hrm_settings`
--
...
--
-- Struktur dari tabel `money_transfers`
--
...
--
-- Dumping data untuk tabel `money_transfers`
--
...
--
-- Struktur dari tabel `payment_with_cheque`
--
...
--
-- Dumping data untuk tabel `payment_with_cheque`
--
...
--
-- Struktur dari tabel `payment_with_credit_card`
--
...
--
-- Struktur dari tabel `payment_with_gift_card`
--
...
--
-- Dumping data untuk tabel `payment_with_gift_card`
--
...
--
-- Struktur dari tabel `payment_with_paypal`
--
...
--
-- Struktur dari tabel `pos_setting`
--
...
--
-- Dumping data untuk tabel `pos_setting`
--
...
(5, 'Baby doll', '31261512', 'standard', 'C128', 3, 4, 1, 1, 1, '100', '120', 139, 50, 1, '100', '2020-02-28', '2020-02-29', NULL, 1, 'lalacrybabydoll.jpg,1572515542825e4e2e433-e29b-4ca1-abb2-aad995574f2a_1.e4dc9f20c1d8b2999d66556ae0aa1600.jpeg', NULL, NULL, 1, NULL, NULL, NULL, '', 1, '2018-05-23 22:58:20', '2020-06-09 06:42:48'),
...
(22, 'iphone-X', '97103461', 'standard', 'C128', 5, 2, 1, 1, 1, '800', '1000', 45, 20, NULL, NULL, NULL, NULL, 1, 1, 'iphoneX.jpg', NULL, NULL, 1, NULL, NULL, NULL, '', 1, '2018-09-03 04:05:17', '2020-07-03 12:39:14'),
...
(25, 'Galaxy S9', '72100265', 'standard', 'C128', NULL, 2, 1, 1, 1, '500', '1000', 29, 50, NULL, NULL, NULL, NULL, 1, 1, 'SamsungGalaxyS9.jpg', NULL, NULL, 1, NULL, NULL, NULL, '', 1, '2018-10-23 01:13:22', '2020-07-03 12:39:14'),
...
(30, 'Polo Shirt', '53467102', 'standard', 'C128', NULL, 12, 1, 1, 1, '50', '100', 28, 10, NULL, NULL, NULL, NULL, NULL, 1, 'PoloShirt.jpg', NULL, NULL, 1, NULL, NULL, NULL, '', 1, '2018-12-04 23:29:43', '2020-04-06 13:41:11'),
...
--
-- Struktur dari tabel `product_quotation`
--
...
--
-- Dumping data untuk tabel `product_quotation`
--
...
--
-- Dumping data untuk tabel `product_returns`
--
...
--
-- Struktur dari tabel `product_transfer`
--
...
--
-- Dumping data untuk tabel `product_transfer`
--
...
--
-- Struktur dari tabel `product_warehouse`
--
...
--
-- Dumping data untuk tabel `product_warehouse`
--
...
(17, '1', NULL, 2, 71.5, '2018-08-08 11:33:33', '2020-07-03 12:39:14'),
(18, '3', NULL, 2, 68, '2018-08-08 23:47:23', '2020-06-22 09:49:57'),
...
(23, '22', NULL, 2, 21, '2018-09-03 04:07:14', '2020-07-03 12:39:14'),
(24, '24', NULL, 2, 0, '2018-09-15 21:49:30', '2018-09-15 21:50:49'),
(25, '25', NULL, 1, 14, '2018-10-23 01:14:21', '2019-03-02 10:06:10'),
(26, '25', NULL, 2, 15, '2018-10-23 01:14:41', '2020-07-03 12:39:14'),
(27, '31', NULL, 1, 14, '2018-12-04 23:34:30', '2019-04-13 13:50:08'),
(28, '30', NULL, 1, 15, '2018-12-04 23:34:30', '2020-04-06 13:53:31'),
(29, '31', NULL, 2, 15, '2018-12-04 23:35:08', '2020-04-06 13:41:11'),
(30, '30', NULL, 2, 13, '2018-12-04 23:35:08', '2020-04-06 13:53:31'),
...
--
-- Struktur dari tabel `purchase_product_return`
--
...
--
-- Dumping data untuk tabel `purchase_product_return`
--
...
--
-- Struktur dari tabel `return_purchases`
--
...
--
-- Dumping data untuk tabel `return_purchases`
--
...
--
-- Struktur dari tabel `stock_counts`
--
...
--
-- Dumping data untuk tabel `stock_counts`
--
...
(1, 'admin', 'admin@gmail.com', '$2y$10$DWAHTfjcvwCpOCXaJg11MOhsqns03uvlwiSUOQwkHL2YYrtrXPcL6', 'ocdOLeCVsnvAISuBs9tkADhEeloRq6p1ZIJJWWMXeNBa6LjESUxfjhoCwQEM', '12112', 'lioncoders', 1, NULL, NULL, 1, 0, '2018-06-02 03:24:15', '2018-09-05 00:14:15'),
...
--
-- Indeks untuk tabel `gift_card_recharges`
--
...
--
-- Indeks untuk tabel `hrm_settings`
--
...
--
-- Indeks untuk tabel `money_transfers`
--
...
--
-- Indeks untuk tabel `payment_with_cheque`
--
ALTER TABLE `payment_with_cheque`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `payment_with_credit_card`
--
ALTER TABLE `payment_with_credit_card`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `payment_with_gift_card`
--
ALTER TABLE `payment_with_gift_card`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `payment_with_paypal`
--
...
--
-- Indeks untuk tabel `pos_setting`
--
...
--
-- Indeks untuk tabel `product_adjustments`
--
...
--
-- Indeks untuk tabel `product_quotation`
--
...
--
-- Indeks untuk tabel `product_transfer`
--
...
--
-- Indeks untuk tabel `product_warehouse`
--
...
--
-- Indeks untuk tabel `purchase_product_return`
--
...
--
-- Indeks untuk tabel `return_purchases`
--
...
--
-- Indeks untuk tabel `stock_counts`
--
...
--
-- AUTO_INCREMENT untuk tabel `billers`
--
ALTER TABLE `billers`
...
--
-- AUTO_INCREMENT untuk tabel `gift_card_recharges`
--
ALTER TABLE `gift_card_recharges`
...
--
-- AUTO_INCREMENT untuk tabel `hrm_settings`
--
ALTER TABLE `hrm_settings`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT untuk tabel `money_transfers`
--
ALTER TABLE `money_transfers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT untuk tabel `payment_with_cheque`
--
ALTER TABLE `payment_with_cheque`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `payment_with_credit_card`
--
ALTER TABLE `payment_with_credit_card`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `payment_with_gift_card`
--
ALTER TABLE `payment_with_gift_card`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `payment_with_paypal`
--
ALTER TABLE `payment_with_paypal`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `product_quotation`
--
ALTER TABLE `product_quotation`
...
--
-- AUTO_INCREMENT untuk tabel `product_transfer`
--
ALTER TABLE `product_transfer`
...
--
-- AUTO_INCREMENT untuk tabel `product_warehouse`
--
ALTER TABLE `product_warehouse`
...
--
-- AUTO_INCREMENT untuk tabel `purchase_product_return`
--
ALTER TABLE `purchase_product_return`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT untuk tabel `return_purchases`
--
ALTER TABLE `return_purchases`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT untuk tabel `stock_counts`
--
ALTER TABLE `stock_counts`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
